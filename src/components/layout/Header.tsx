    ...
    <>
      ...
      >
        <div className="w-full max-w-[1600px] mx-auto flex items-center justify-between gap-3">
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <nav className="hidden md:flex items-center gap-6 text-[14px] font-bold tracking-tight text-white/50">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-5 text-[16px] font-bold text-white/50">
              {/* Mobile Search */}
